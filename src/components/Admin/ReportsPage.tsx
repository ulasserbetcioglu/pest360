...
const ReportsPage: React.FC = () => {
  ...
  const reportData = {
    ...
    trends: {
      visitsByMonth: [
        { month: 'Ocak', visits: 45 },
        { month: 'Şubat', visits: 52 },
        { month: 'Mart', visits: 59 }
      ],
      revenueByMonth: [
        { month: 'Ocak', revenue: 8200 },
        { month: 'Şubat', revenue: 9500 },
        { month: 'Mart', revenue: 10800 }
      ]
    }
  };
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-green-600 mt-1">Demo sistem</p>
            </div>
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-blue-600 mt-1">Demo veri</p>
            </div>
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="text-center">
            ...
            <p className="text-xs text-gray-600">Demo sistem</p>
          </div>
          <div className="text-center">
